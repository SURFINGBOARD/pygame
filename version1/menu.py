...
FONTS = [
    pygame.font.Font(font, 40) for size in [36, 28, 18]
]
...
class Menu():
    ...
    def draw_all(self):  #
        ...
        if self.win_status == "menu":
            ...
            self.button_rects = {}
            self.button_rects["start"] = self.draw_button("Start game", 250)
            self.button_rects["setting"] = self.draw_button("Setting", 300, 1)
            self.button_rects["quit"] = self.draw_button("Quit", 350, 2)
